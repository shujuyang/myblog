        ...
        <form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请输入权限名称" id="ps_name" name="ps_name" />
                </div>
            </div>
                ...
                <div class="formControls col-xs-8 col-sm-9">
			        ...
			        <select class="select" name="ps_pid" size="1">
                        ...
                        @foreach($permissions as $permission)
                            <option value="{{ $permission->ps_id }}">{{ $permission->ps_name }}</option>
                        @endforeach
			        </select>
			        </span>
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请输入控制器名称" id="ps_c" name="ps_c" />
                </div>
            </div>
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>控制器：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请输入方法名称" id="ps_a" name="ps_a" />
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" placeholder="请输入访问地址" id="address" name="address" />
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
			        ...
			        <select class="select" name="ps_level" size="1">
                            <option value="0">1级权限</option>
                            <option value="1">2级权限</option>
                            <option value="2">3级权限</option>
			        </select>
			        </span>
                </div>
            </div>
