...
class Article extends Authenticatable
{
    ...
    protected $fillable = ['ar_title','ar_editor','ar_content','ar_desc','img_path','ar_tag_name','ar_column_id','is_new','is_hot','is_top','view_count','favorite_count','comment_count'];
